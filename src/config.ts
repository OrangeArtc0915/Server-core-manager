...
export const siteConfig: SiteConfig = {
	...
	subtitle: "让带图形界面的程序，在 Windows Server Core 上真正跑起来",
	keywords: ["Server Core", "Windows Server", "图形界面", "GUI", "FOD", "ServerCoreManager"],
	...
	banner: {
		...
		homeText: {
			...
			title: "Server Core Manager", // 主页横幅主标题

			subtitle: [
				"让带图形界面的程序，在 Server Core 上真正跑起来",
				"补齐图形环境 · 添加程序 · 启动排障",
				"每条结论都来自真机实测",
				"GPL-3.0 开源",
			],
...
export const licenseConfig: LicenseConfig = {
	enable: true,
	name: "GPL-3.0",
	url: "https://github.com/OrangeArtc0915/Server-core-manager/blob/main/LICENSE",
};
